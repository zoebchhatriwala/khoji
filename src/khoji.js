...
(function() {
    ...
    function _khoj(selector) {
        var qElement = !!this && !!this.querySelector ? this : document;
    ...
    function _sabKhoj(selector) {
        var qElement = !!this && !!this.querySelectorAll ? this : document;
        var sElements = qElement.querySelectorAll(selector);
        return _phir(sElements);
    }
